...
import static com.stockholmiot.proxyguide.ui.nearby.Constants.TAG;
...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    private final ArrayList<String> mDiscoveredList = new ArrayList<>();
    /**
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unusedResult) {
                                ...
                                /*docRef.update("isNearby", true).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Log.d(TAG, "Success update nearby status: ");
                                    }
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                docRef.update("isNearby", false).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            Log.d(Constants.TAG, "Success update nearby status: ");
                                ...
                                /*docRef.update("isNearby", false).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Log.d(TAG, "Success update nearby status: ");
                                    }
    ...
    protected void stopAdvertising() {
        ...
        //update the status of advertising on Firebase
        FirebaseUser currentUser = FirebaseUtil.getAuth().getCurrentUser();
                        ...
                        new EndpointDiscoveryCallback() {
                            ...
                            public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                                ...
                                if (getServiceId().equals(info.getServiceId())) {
                                    ...
                                    String currentUserId =  info.getEndpointName();
                                    mDiscoveredList.add(currentUserId);
                            ...
                            public void onEndpointLost(String endpointId) {
                                ...
                                String currentUserId = FirebaseUtil.getAuth().getCurrentUser().getUid();
                                //mDiscoveredList.remove(currentUserId);
                            }
                        },
    ...
    public ArrayList<String> getmDiscoveredList() {
